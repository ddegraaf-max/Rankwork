...
function bouwTaken(result) {
  ...
  site('dubbele-titles', sc.dubbeleTitles > 0, 'Dubbele page titles',
    `${sc.dubbeleTitles || 0} pagina's delen dezelfde <title>. Geef elke pagina een unieke title met eigen zoekwoord — `
    + 'identieke titles concurreren met elkaar in Google.', 'hoog');
  site('dubbele-descriptions', sc.dubbeleDescriptions > 0, 'Dubbele meta descriptions',
    `${sc.dubbeleDescriptions || 0} pagina's delen dezelfde meta description. Schrijf per pagina een eigen description.`, 'laag');
